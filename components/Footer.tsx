        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <div>
                <span className="text-xl font-bold">24/7 UAE</span>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-zinc-800 hover:bg-orange-500 rounded-full flex items-center justify-center transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: "/locations", label: "Coverage Areas" },
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { href: "/services/car-recovery", label: "Car Recovery" },
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    <p className="font-medium text-white">info@247uaerecovery.ae</p>
              ...
              <li className="flex items-start gap-3 text-zinc-400">
                ...
                <div>
                  ...
                  <p className="text-sm">Serving All Emirates</p>
                </div>
              </li>
              <li className="flex items-start gap-3 text-zinc-400">
                ...
                <div>
                  ...
                  <p className="text-sm">Including Holidays</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <Link href="/terms" className="text-zinc-500 hover:text-orange-500 transition-colors">
                Terms of Service
              </Link>
            </div>
          </div>
