        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/careers" className="text-orange-500 font-medium">Careers</Link>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link href="/careers" className="block text-zinc-400 hover:text-orange-500">Careers</Link>
            ...
            <div>
              ...
              <div className="space-y-2 text-zinc-400 text-sm">
                <p className="flex items-center gap-2"><Mail className="w-4 h-4" /> careers@247uaerecovery.ae</p>
