...
export const metadata: Metadata = {
  ...
  description:
    "Emergency accident recovery service in Dubai. Police-coordinated, insurance-friendly. We handle scene safety, documentation & vehicle transport. Priority response. Call +971 56 977 3000.",
  keywords: [
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-red-500 to-orange-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            ...
            <a
              href="https://wa.me/971569773000?text=Emergency!%20I%20need%20accident%20recovery"
