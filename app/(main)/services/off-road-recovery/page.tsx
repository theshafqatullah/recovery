      ...
      <footer className="py-12 px-4 bg-zinc-900 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-semibold mb-4">Specialty Services</h4>
              <div className="space-y-2">
                <Link href="/services/off-road-recovery" className="block text-zinc-400 hover:text-orange-500">Desert Recovery</Link>
                <Link href="/services/motorcycle-recovery" className="block text-zinc-400 hover:text-orange-500">Motorcycle Recovery</Link>
                <Link href="/services/heavy-vehicle" className="block text-zinc-400 hover:text-orange-500">Heavy Vehicle</Link>
                <Link href="/services/long-distance" className="block text-zinc-400 hover:text-orange-500">Long Distance</Link>
              </div>
            </div>
            <div>
