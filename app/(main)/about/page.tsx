        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-zinc-400 text-sm">
                <p className="flex items-center gap-2"><Phone className="w-4 h-4 text-orange-500" /> +971 50 464 5696</p>
                <p className="flex items-center gap-2"><Mail className="w-4 h-4 text-orange-500" /> info@247uaerecovery.ae</p>
                <p className="flex items-center gap-2"><MapPin className="w-4 h-4 text-orange-500" /> Dubai, UAE</p>
              </div>
            </div>
          </div>
